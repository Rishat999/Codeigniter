$(document).ready(function(){
    ...
    $(".puppy_delete_btn").click(function(){
    	...
    	$(".delete_puppy_confirm_btn").click(function(e){
    		$.ajax({
	            url : '/dogs/del_dog',
	            type : 'POST',
	            data : {"delete_id": delete_puppy_id ,"category" : 'puppy'},
	            success : function(response) {
	            	console.log(response);
    ...
    $(".stud_delete_btn").click(function(){
    	...
    	$(".delete_stud_confirm_btn").click(function(e){
    		$.ajax({
	            url : '/dogs/del_dog',
	            type : 'POST',
	            data : {"delete_id": delete_stud_id ,"category" : 'stud'},
	            success : function(response) {
	            	console.log(response);
	            	if(response == 'successsuccess')
	            	{	
    ...
    $(".adult_delete_btn").click(function(){
    	...
    	$(".delete_adult_confirm_btn").click(function(e){
    		$.ajax({
	            url : '/dogs/del_dog',
	            type : 'POST',
	            data : {"delete_id": delete_adult_id ,"category" : 'adult'},
	            success : function(response) {
	            	console.log(response);
	            	if(response == 'successsuccess')
	            	{	
    ...
    $(".upload_dog").submit(function(e){
    	...
    	//var make_data = $(this).serialize()+0
    	$.ajax({
	...
	$(".edit_dog").submit(function(e){
    	...
    	$.ajax({
	            ...
	            success : function(response) {
	            	...
	            	{	
		                Lobibox.notify('success', {
					        msg: 'The Dog : ' + "<b style='color:#000;'>" +dog_name+'  ' +"</b>"+"is updated!"
					    });
    ...
    $("#cms").submit(function(e){
    	e.preventDefault();
    	var cms_data = $(this).serialize();
    	console.log(cms_data);
    	$.ajax({
	            url : '/admin/update_cms',
	            type : 'POST',
	            data : cms_data,
	            success : function(response) {
	            	console.log(response);
