                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box" >           
                                ...
                                <p class="text-center" style="font-size:1.5em;margin-top: 5%;padding-left: 5%;padding-right: 5%;color: #fff;">Woohoo! No <b>studs</b> exist! | <a href="#" onclick='location.reload(true); return false;'>Reload</a>
                                </p>
...
<script>
  console.log("here1");
  console.log($(".individual_dog").length);
