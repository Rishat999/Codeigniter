        ...
        <div class="col-xs-12">
          <div class="box" >
            <?php if(empty($studs)) {?>
                ...
                <p class="text-center text-danger" style="font-size:1.5em;">Woohoo! No Stud exist! | <a href="#" onclick='location.reload(true); return false;'>Reload</a>
                </p>
                <div class="error-page" style="margin: 0px;  text-align: center;  margin-left: 15%;  padding-bottom: 3%;">
                    ...
                    <div class="error-content">
                      <h3><i class="fa fa-warning text-yellow"></i> Oops! No Stud exist.</h3>
                      <p>
            ...
            <?php }
                                ...
                                <tbody>                        
                                  ...
                                  ?>                        
                                      ...
                                      <tr>
                                        ...
                                        <td class="mailbox-name">
                                          <a href="/breeder/view?id=<?=$stud['breeder_id'];?>" class="breeder_details" id="<?php echo $stud['breeder_id'];?>" target="_blank"><?php echo $stud['vendor_name'];?> </a>
                                        ...
                                        <td style="width: 9%;">
                                          ...
                                          <a class="stud_delete_btn" data-toggle="modal" data-target="#delete_stud"  id="<?php echo $stud['id'];?>"><i class="fa fa-times" style="font-size: 20px; cursor: pointer;" data-toggle="tooltip"  title="Delete" data-placement="top"></i></a>                  
                                      </td>                                 
                                      </tr>
                                  <?php endforeach;?>
                                </tbody>
              ...
              <!-- <div class="table-responsive">  
                  <div class="box-body">        
                  <div class="box-body no-padding <?php if(!$studs) echo 'hide';?>">
                  <table id="tbl_studs" class="table table-striped table-bordered zero-configuration" >
                    <thead>
                      <tr>        
                          <th>No</th>
                          <th>Name</th> 
                    ...
                    <tbody>                        
                      ...
                      ?>                        
                          ...
                          <tr>
                            ...
                            <td class="mailbox-name" style="width: 50px;">
                              <img src="<?php if(empty($stud['photo'])) echo base_url().'assets/img/default_dog.png'; else echo $stud['photo'];?>" style="width: 50px;">
                            </td>
                            <td class="doc_desc_cell">
                              <p><?php echo $stud['description'];?></p>                          
                            </td>
                            <td class="mailbox-name">
                             <?php echo $stud['breeder_name'];?> 
                            </td>
                            <td class="mailbox-name">
                             <?php echo $stud['city'];?> 
                            </td>
                            ...
                            <td class="mailbox-name">
                              <span class="pull-right-container">
                                <small class="label bg-yellow" style="font-size: 15px;"><?php echo $stud['status'];?></small>
                              </span>                               
                            </td>                        
                            <td style="width: 9%;">
                              <a href="/dogs/view?id=<?=$stud['id'];?>" class="stud_details" id="<?php echo $stud['id'];?>" target="_blank"><i class="fa fa-eye" style="font-size: 20px; cursor: pointer;"  data-toggle="tooltip" title="View" data-placement="top"></i></a> | 
...
<div class="modal fade" id="delete_stud">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-body">                
                <h4>Are you sure you want to delete this Stud?</h4>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal"><i class="fa fa-times"></i> Cancel</button>
                <button type="button" name="remove" class="btn-delete btn btn-danger delete_stud_confirm_btn" data-dismiss="modal"><i class="fa fa-trash"></i> Confirm</button>
            </div>
        </div>
    </div>
</div>
